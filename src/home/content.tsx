  ...
  render(){
    return(
      <div>
        ...
        <div id="pane-what-can-you-make" className="pane bg-neutral-11">
        ...
        <div className="pane bg-npm-navy-1" id="enterprise-homepage-pane" style={{backgroundColor:'#273547'}}>
          <div className="container">
            <div className="row">
              <div className="col-md-4 col-md-offset-1">
                <img className="img-responsive center-block" src="home/imgs/npm-enterprise.svg" alt="good businesses scale"/>
              </div>
        ...
        <div className="pane" style={{backgroundColor:'#206F9C'}}>
          <div className="container">
            <div className="row">
              <div className="col-md-4 col-md-offset-1">
                <img className="featurette-image img-responsive center-block" src="home/imgs/content2.png" alt="Generic placeholder image"></img>
              </div>
              <div className="col-md-5  col-md-offset-1">
                <div className="visible-lg-block mtxxl ptxxl"></div>
                <div className="visible-md-block mtxxl"></div>
